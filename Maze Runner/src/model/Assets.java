...
public class Assets {
	...
	public static BufferedImage  stone, tree, path, bomb_0,bomb_1, gift_score, gift_health, shield_left, shield_right, kunai, checkpoint, prize;

	public static BufferedImage[] runner_left_run, runner_right_run, runner_left_idle, runner_right_idle, runner_left_dead, runner_right_dead,runner_left_attack, runner_right_attack;
	...
	public static void init() {
		...
		checkpoint = ImageLoader.loadImage("/icons8-near-me-64.png");
		prize = ImageLoader.loadImage("/prize.png");
		// runner animations
		...
		runner_left_dead = new  BufferedImage[10];
		runner_right_dead = new  BufferedImage[10];
		runner_left_attack = new  BufferedImage[10];
		runner_right_attack = new  BufferedImage[10];
		...
		for (int i = 0; i < 10; i++) {
			...
			runner_left_dead[i] = ImageLoader.loadImage("/runner/left/dead/Dead__00" + i + ".png");
			runner_right_dead[i] = ImageLoader.loadImage("/runner/right/dead/Dead__00" + i + ".png");
			runner_left_attack[i] = ImageLoader.loadImage("/runner/left/attack/Attack__00" + i + ".png");
			runner_right_attack[i] = ImageLoader.loadImage("/runner/right/attack/Attack__00" + i + ".png");
		}
	}
